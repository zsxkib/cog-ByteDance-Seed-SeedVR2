...
SeedVR2-3B is ByteDance-Seed's one-step diffusion transformer for restoring soft,
...
> **Status:** This repo currently wraps the SeedVR2 **3B** checkpoint. Additional
> parameter variants and exposed knobs will land here once they’re validated for
> Replicate builds.

## Highlights
- One-step restoration for both videos and single-frame images.
...
| `sp_size` | integer | Sequence-parallel shards for long videos. | `1` |
